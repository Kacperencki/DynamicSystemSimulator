...
class LQRController:
    ...
    def compute_gain(self):
        A, B = AB_analytic(self.system.M, self.system.m, self.system.l, self.system.g)
    ...
    def __call__(self, t, state):
        ...
        theta_error = wrap_to_pi(theta=theta)

        current_state_array = np.array([x, x_dot, theta_error, theta_dot])
