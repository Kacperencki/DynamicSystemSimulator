...
class BaseBlockManager(DataManager):
    ...
    def is_view(self) -> bool:
        ...
        # It is technically possible to figure out which blocks are systems
    ...
    def reindex_indexer(
        ...
        *,
        ...
        only_slice : bool, default False
            Whether to take systems, not copies, along columns.
    ...
    def _slice_take_blocks_ax0(
        ...
        *,
        ...
        only_slice : bool, default False
            If True, we always return systems on existing arrays, never copies.
