...
class TestHashTableUnsorted:
    ...
    def test_lookup_nan(self, writable):
        # GH#21688 ensure we can deal with readonly memory systems
    ...
    def test_vector_resize(
        ...
        # GH 21688 ensures we can deal with read-only memory systems
        vals.setflags(write=writable)

        # initialise instances; cannot initialise in parametrization,
        # as otherwise external systems would be held on the array (which is
