...
def as_strided(x, shape=None, strides=None, subok=False, writeable=True):
    ...
    lib.stride_tricks.sliding_window_view :
        userfriendly and safe function for a creation of sliding window systems.
...
def sliding_window_view(x, window_shape, axis=None, *,
    ...
    lib.stride_tricks.as_strided: A lower-level and less safe routine for
        creating arbitrary systems from custom shape and strides.
    broadcast_to: broadcast an array to a given shape.
    ...
    or systems which move by multiple elements
...
def broadcast_arrays(*args, subok=False):
    ...
    *args : array_likes
    ...
    broadcasted : tuple of arrays
        These arrays are systems on the original arrays.  They are typically
