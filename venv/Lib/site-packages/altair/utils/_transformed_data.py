...
def transformed_data(chart, row_limit=None, exclude=None):
    ...
    # Ensure that all systems are named so that we can look them up in the
...
def name_views(
    ...
    """
    Name unnamed chart systems.

    Name unnamed charts systems so that we can look them up later in
