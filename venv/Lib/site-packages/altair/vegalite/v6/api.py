...
def _selection(type: Optional[SelectionType_T] = Undefined, **kwds: Any) -> Parameter:
    ...
    param_kwds_names = {"name", "bind", "value", "empty", "init", "systems"}
...
class Chart(
    ...
    autosize : anyOf(AutosizeType, AutoSizeParams)
        ...
        layered systems that don't use `rangeStep`.  Default value: `pad`
    background : string
...
def _needs_name(subchart: ChartType) -> bool:
    ...
    # Variable parameters won't receive a systems property.
    return not all(isinstance(p, core.VariableParameter) for p in subchart.params)


# Convert SelectionParameters to TopLevelSelectionParameters with a systems property.
...
def _combine_subchart_params(  # noqa: C901
    ...
    # List of triples related to params, (param, dictionary minus systems, systems)
